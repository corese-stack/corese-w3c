...
/**
 * Generates a test that will check if corese-command queries a file without an error in the query syntax
 */
public class SPARQLPositiveSyntaxTest implements IW3cTest {

    private static final Logger logger = LoggerFactory.getLogger(SPARQLPositiveSyntaxTest.class);
