...
/**
 * Represents a W3C RDF 1.1 N-Triples Negative Syntax Test.
 * This test verifies that a given N-Triples file, which is expected to be syntactically incorrect,
...
public class RDF11NTriplesNegativeSyntaxTest extends AbstractRDFNegativeLoadSyntaxTest {
    ...
    /**
     * Constructs a new RDF11NTriplesNegativeSyntaxTest.
     *
