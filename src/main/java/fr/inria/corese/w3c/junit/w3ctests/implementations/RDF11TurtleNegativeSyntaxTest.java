...
/**
 * Represents a W3C RDF 1.1 Turtle Negative Syntax Test.
 * This test verifies that a given Turtle file, which is expected to be syntactically incorrect,
...
public class RDF11TurtleNegativeSyntaxTest extends AbstractRDFNegativeLoadSyntaxTest {
    ...
    /**
     * Constructs a new RDF11TurtleNegativeSyntaxTest.
     *
