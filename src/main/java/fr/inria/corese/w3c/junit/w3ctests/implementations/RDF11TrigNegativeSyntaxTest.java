...
/**
 * Represents a W3C RDF 1.1 Trig Negative Syntax Test.
 * This test verifies that a given Trig file, which is expected to be syntactically incorrect,
...
public class RDF11TrigNegativeSyntaxTest extends AbstractRDFNegativeLoadSyntaxTest {
    ...
    /**
     * Constructs a new RDF11TrigNegativeSyntaxTest.
     *
