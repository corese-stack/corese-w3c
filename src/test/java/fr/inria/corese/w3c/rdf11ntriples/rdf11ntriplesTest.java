...
public class rdf11ntriplesTest {
    ...
    public void comment_following_triple() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/comment_following_triple.nt"));
    ...
    public void langtagged_string() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/langtagged_string.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void lantag_with_subtag() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/lantag_with_subtag.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_all_controls() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_all_controls.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_all_punctuation() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_all_punctuation.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_ascii_boundaries() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_ascii_boundaries.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_2_dquotes() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_2_dquotes.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_2_squotes() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_2_squotes.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_backspace() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_BACKSPACE.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_carriage_return() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_CARRIAGE_RETURN.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_character_tabulation() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_CHARACTER_TABULATION.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_form_feed() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_FORM_FEED.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_line_feed() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_LINE_FEED.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_reverse_solidus() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_REVERSE_SOLIDUS.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_reverse_solidus2() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_REVERSE_SOLIDUS2.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_utf8_boundaries() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_UTF8_boundaries.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_dquote() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_dquote.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_numeric_escape4() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_numeric_escape4.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_numeric_escape8() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_numeric_escape8.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void literal_with_squote() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/literal_with_squote.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void minimal_whitespace() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/minimal_whitespace.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadbase01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-base-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadbnode01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-bnode-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadbnode02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-bnode-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadesc01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-esc-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadesc02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-esc-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadesc03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-esc-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadlang01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-lang-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadnum01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-num-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadnum02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-num-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadnum03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-num-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadprefix01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-prefix-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstring01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-string-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstring02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-string-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstring03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-string-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstring04() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-string-04.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstring05() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-string-05.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstring06() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-string-06.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstring07() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-string-07.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstruct01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-struct-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbadstruct02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-struct-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri04() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-04.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri05() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-05.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri06() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-06.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri07() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-07.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri08() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-08.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbaduri09() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bad-uri-09.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbnode01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bnode-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbnode02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bnode-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxbnode03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-bnode-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxdatatypes01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-datatypes-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxdatatypes02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-datatypes-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxfile01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-file-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxfile02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-file-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxfile03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-file-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxstresc01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-str-esc-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxstresc02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-str-esc-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxstresc03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-str-esc-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxstring01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-string-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxstring02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-string-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxstring03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-string-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxsubm01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-subm-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxuri01() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-uri-01.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxuri02() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-uri-02.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxuri03() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-uri-03.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
    ...
    public void ntsyntaxuri04() throws IOException, NoSuchAlgorithmException, InterruptedException {
        // Load action file
        Path testFilePath = TestFileManager.loadTestFile(URI.create("https://w3c.github.io/rdf-tests/rdf/rdf11/rdf-n-triples/nt-syntax-uri-04.nt"));
        Process command = new ProcessBuilder().inheritIO().command(
                "corese-command", "sparql",
                "-i", testFilePath.toString(),
                "-if", "ntriples",
